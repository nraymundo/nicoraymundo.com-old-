  ...
  return (
    <div className="container">
      ...
      <div className="extra-info">
        ...
        <div onClick={() => window.open(projectInfo.github, "_blank")}>
          <svg xmlns="http://www.w3.org/2000/svg" onclick="alert('click!')" fill='white' width="30" height="30" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 
            ...
            3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 
